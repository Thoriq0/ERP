...
export function ReportsDataAttendance({ data, user }) {
  ...
  function groupAttendance(data, user) {
    const grouped = {};
    data.forEach(item => {
      ...
      const foundUser = user.find((usr) => usr.id === item.user_id);
...
export default ReportsDataAttendance;
