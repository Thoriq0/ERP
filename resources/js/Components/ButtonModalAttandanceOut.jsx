  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="w-1/2 mx-auto bg-gradient-to-r from-red-500 to-yellow-400 shadow-lg hover:shadow-xl transition-all duration-300">Attandance Out</Button>
      </DialogTrigger>
