  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="w-1/2 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 text-white shadow-lg hover:shadow-xl transition-all duration-300">Attandance In</Button>
      </DialogTrigger>
            ...
            {!captured ? (
              ...
              <>
                ...
                <div className="mt-4 flex justify-center gap-4">
                  ...
                  >
                    {loading ? 'Mengirim...' : 'Sumbit Attandance'}
                  </button>
                  <button
                    onClick={retakePhoto}
