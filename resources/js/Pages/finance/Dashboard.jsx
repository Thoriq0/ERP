...
export default function DashboardFinance({auth, title, total_payment, total_unpaid, py_schedule, total_bp, paymentData}) {
    return (
        <DashboardFinanceLayout auth={auth}>
            ...
            <div className="p-6">
                        ...
                        <div className='flex flex-col md:flex-row justify-around gap-10 md:gap-0'>
                            ...
                            <div className='flex flex-col'>
                                <div className='ml-16 md:ml-0'>
                                    <img src="/images/cashless-payment.png" alt="Total Payment" className='w-[25px]'/>
                                    <h1 className='mt-3 text-md font-extrabold'>Total Payment</h1>
                                </div>
                ...
                <div className='flex flex-col justify-center items-center md:flex-row gap-5 mb-10'>
                    <div className='md:h-[500px] border border-borderCard rounded-xl shadow-2xl p-5 md:w-[500px]'>
                        <h1 className='font-bold text-lg'>Total Payment</h1>
                        <div className='h-px bg-[#C8C6C6] mt-2 mb-5'></div>
                        <PieChartTotalPayment data={paymentData}/>
                    </div>
                    <div className='md:h-[500px] border border-borderCard rounded-xl shadow-2xl p-5 md:w-[500px]'>
                        <h1 className='font-bold text-lg'>Total Validasi Account Payable</h1>
                        <div className='h-px bg-[#C8C6C6] mt-2 mb-5'></div>
