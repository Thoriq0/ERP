...
import DataTableBudgetControl from "@/Components/DataTables/DataTableBudgetControl";
    ...
    return (
        <Layout auth={auth}>
            ...
            <div className="p-6 mt-14">
              <DataTableBudgetControl mustVerifyEmail={mustVerifyEmail} status={status} data={data} />
          </div>
