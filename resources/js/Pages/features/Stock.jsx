...
export default function Stock({auth, mustVerifyEmail, status, title, stock, adjust}) {
    ...
    return (
        <Layout auth={auth}>
            ...
            <div className="p-6 mt-14">
              <DataTableStock mustVerifyEmail={mustVerifyEmail} status={status} data={stockData} userRole={role} adjust={adjust} />
          </div>
