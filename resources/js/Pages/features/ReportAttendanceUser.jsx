...
import ReportsDataAttendanceUser from "@/Components/DataTables/report/ReportsDataAttendanceUser";
import ToasterComponent from "@/Components/ToasterComponent";

export default function ReportAttendanceUser({auth, mustVerifyEmail, status, title, attendance, usr}) {
    ...
    return (
        <Layout auth={auth}>
            ...
            <div className="p-6 mt-14">
                <ReportsDataAttendanceUser mustVerifyEmail={mustVerifyEmail} status={status} data={data} userRole={role} roleName={roleName} user={usr}  />
            </div>
